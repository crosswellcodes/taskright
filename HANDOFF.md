...
**Last updated: July 6, 2026 (Session 14 — Service Model Components 1–4 DONE → FEATURE COMPLETE: per-customer Services (data+backend) + customer-profile builder + Templates browser & "save as template" + C4 vocabulary cleanup (renamed /service-cycles→/service-templates, dropped /assign-cycle). 118/118 backend tests. See Pending Work.)**
