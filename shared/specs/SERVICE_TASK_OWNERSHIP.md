...
> - **Step E — Docs + commit** (this section; `SERVICE_MODEL.md` pointer, `HANDOFF.md`, `API_REFERENCE.md`, memory). (Migration `024` reservation released — used by `024_decimal_service_hours` for the fractional-hours fix.)
