...
const businessScreens: Screen[] = [
  ...
  },
  {
    ...
    hotspots: [
      ...
      { title: 'Submission status pill', description: 'Each customer row shows their submission status — green Submitted when tasks are locked in, amber Pending when they still need to select.',             top: '27%', left: '28%' },
